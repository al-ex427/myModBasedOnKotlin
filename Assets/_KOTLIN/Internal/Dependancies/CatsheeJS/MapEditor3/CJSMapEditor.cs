...
public class CJSMapEditor : EditorWindow
{
    ...
    [MenuItem("KOTLIN External/Map Editor")]
    private static void CreateWindow()
    {
        CJSMapEditor window = GetWindow<CJSMapEditor>(false, "Map Editor");
    ...
    private void RenderHome()
    {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.HelpBox("What decomp are you using?", MessageType.Info); 
    ...
    private void RenderEditor_Edit()
    {
        ...
        if (currSelectionType == TileObject.Wall)
        {
            ...
            {
                if (currDecomp == Decomp.KOTLIN) //im too fucking lazy 
                {
